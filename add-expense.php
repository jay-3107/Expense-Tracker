...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            <form action="add-expense-save.php" method="post" class="needs-validation" enctype="multipart/form-data">
                <!-- start page title -->
                <!-- end page title -->
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row gy-3">
                                    <?php
                                       $data = $database->select('accounts', 'account_name', ['user_id' => $user['id']]);
                                    ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-select" id="accounts" name="accounts"
                                                required>
                                                <option value="" disabled selected>Please select Accounts</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-select" id="group" name="group" required>
                                    ...
                                    <?php
                                    // Assume the database query to retrieve categories is already defined above this point
                                    $users = $database->select('categories', ['category_id', 'category_name'], ['parent_id' => 0, 'user_id' => $user_id]);
                                    ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-select" id="category" name="category"
                                                ...
                                                <option value="<?php echo $user['category_id']; ?>">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-select" id="subcategory" name="subcategory"
                                                required>
                                                <option value="" disabled selected>Please select Subcategory</option>
                                                <option value="None">None</option>
                                                <!-- Subcategory options will be dynamically populated using JavaScript -->
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="expensedate">Expensne Date :</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="1" cols="5" id="details"
                                                name="details">
                                        </textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <input type="submit" value="Add Expense" name="submit" class="btn btn-primary mb-2 mt-4">
                                    </div>
                                </div>
                            </div>
                            <!--end col-->
...
$(document).ready(function() {
    $("#category").change(function() {
        var cat_id = $(this).val();
        $("#subcategory").load("get_subcategories.php?category_id=" + cat_id);
    });
})
</script>