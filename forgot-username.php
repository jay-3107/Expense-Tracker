  ...
  if (isset($_GET['submit']))
  {
      ...
      if($userData)
      {
          ...
          if (!$mail->send())
          {
              ...
              echo "<script> alert('Something Went Wrong'); window.location='forgot.username.php'; </script>";
          } 
          else 
          {
              echo "<script>alert('Username sent to Mail Successfully!');</script>";
      ...
      {
          echo "<script>alert('User Not Found...Signup First')</script>";
              ...
              <div class="card mt-4">
                <div class="card-body p-4">
                  <div class="text-center mt-2">
                    ...
                    <p class="text-muted">Reset Username with Expense Tracker</p>
