        ...
        <div class="container">
            <div class="row">
                ...
                <div class="row align-items-center gy-10 mb-3">
                    <div class="col-sm">
                        <div>
                            <h5 class="fs-14 mb-0">Expense Records</h5>
                        </div>
                    </div>
                </div>
                <?php
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-sm-2">
                                ...
                                <ul class="list-inline text-black">
                                    <li class="list-inline-item">
                                        Accounts : <span class="fw-medium"><?php echo $record['accounts']; ?></span>
                                    </li>
                                    <br>
                                    <li class="list-inline-item">
                                        Group : <span class="fw-medium"><?php echo $record['group']; ?></span>
                                    </li>
                                    <br>
                                    <li class="list-inline-item">
                                        Category : <span class="fw-medium"><?php echo $record['category']; ?></span>
                                    </li>
                                    <br>
                                    <li class="list-inline-item">
                                        Subcategory : <span
                                            class="fw-medium"><?php echo $record['subcategory']; ?></span>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-sm ">
                                <ul class="list-inline text-black">
                                    <br>
                                    <li class="list-inline-item">
                                        Rate : <span class="fw-medium"><?php echo $record['rate']; ?></span>
                                    </li><br>
                                    <li class="list-inline-item">
                                        Quantity : <span class="fw-medium"><?php echo $record['quantity']; ?></span>
                                    </li>
                                    <br>
                                    <li class="list-inline-item">
                            ...
                            <div class="col-sm-2 mt-4">
                                <ul class="list-inline text-muted fs-14">
                                    ...
                                    <li class="list-inline-item text-black">
                                        Status : <span
                                            class="fw-medium text-black"><?php echo $record['payment_status']; ?></span>
                                    </li>
                                    <br>
                                    <li class="list-inline-item text-black">
                        ...
                        <div class="row align-items-center gy-3">
                            <div class="col-sm">
                                <div class="d-flex flex-wrap my-n1">
                                    <div>
                                        <div>
                                            <a href="delete-expense-record.php?id=<?php echo $record['id']; ?>"
                                    ...
                                    <div>
                                        <a href="update-expense-record.php?id=<?php echo $record['id']; ?>&date=<?php echo $record['date']; ?>&mop=<?php echo $record['mode']; ?>"
...
function showDeleteConfirmation(groupId) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            deleteLink.href = `delete-expense-record.php?id=${groupId}`;
            deleteLink.click();
        }
    });
}
...
function searchDesktopExpenses() {
    ...
    for (i = 0; i < cards.length; i++) {
        var textElements = cards[i].querySelectorAll(
            '.text-black'); // Assuming the search criteria is based on the text in .text-black elements
