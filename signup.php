                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="signin.php" class="d-inline-block auth-logo">
                                    <img src="assets/images/softanic.png" alt="" height="100" width="100" />
                                </a>
                            </div>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form class="needs-validation" method="post" action="signup-save.php"
                                        ...
                                        <div>
                                            <label for="placeholderInput" class="form-label">Mobile Number<span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="placeholderInput"
                                                placeholder="Enter Your Name" name="mobile" required>
                                            <div class="invalid-feedback">Please enter Name</div>
                                        </div>
                                        <br>
                                        <div>
                                            <label for="placeholderInput" class="form-label">Upload Photo<span
                                                    class="text-danger">*</span></label>
                                            <input type="file" class="form-control" id="placeholderInput" name="photo"
                                            ...
                                            <div class="position-relative auth-pass-inputgroup">
                                                ...
                                                <div class="position-relative auth-pass-inputgroup">
                                                    <input type="password" name="confpassword"
                                                        class="form-control pe-5 password-input" onpaste="return false"
                                                        placeholder="Confirm password" id="confpassword-input"
                                                        aria-describedby="confPasswordInput" required />
                                                    <button
                                                        class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon"
                                                        type="button" id="confpassword-addon"
                                                        onclick="togglePasswordVisibility('confpassword-input', 'confpassword-addon')">
                                                        <i class="ri-eye-fill align-middle"></i>
                                                    </button>
                                                    <div class="invalid-feedback">
